...
Raspberry PI 2 model B has only one ethernet port but its not an issue at all, FreePI is built with support of VLANS, in DYI project I use [Mikrotik RB260GSP](http://routerboard.com/RB260GSP) switch.
